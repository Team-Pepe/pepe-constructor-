                    ...
                    <Card key={zone.id} className="hover:shadow-md transition-shadow">
                      ...
                      <CardContent>
                        ...
                        <div className="grid grid-cols-2 gap-2 text-xs text-gray-500">
                          <div>
                            <span className="font-semibold">Latitud:</span> {zone.lat ? zone.lat.toFixed(6) : zone.latitud?.toFixed(6)}
                          </div>
                          <div>
                            <span className="font-semibold">Longitud:</span> {zone.lng ? zone.lng.toFixed(6) : zone.longitud?.toFixed(6)}
                          </div>
                        </div>
                        <button
                          onClick={() => {
          ...
          <div className="text-center mt-10">
            <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div onClick={() => setActiveSection("mapa")} className="p-4 border rounded-md cursor-pointer hover:bg-blue-50">
                  <h4 className="font-medium text-blue-700">Mi Ubicación</h4>
                  <p className="text-sm text-gray-500">Ver tu ubicación actual en el mapa y zonas cercanas</p>
                </div>
                
                <div onClick={() => setActiveSection("zonas-guardadas")} className="p-4 border rounded-md cursor-pointer hover:bg-blue-50">
                  <h4 className="font-medium text-blue-700">Zonas Guardadas</h4>
